# Commodore Component: rbac

This is a [Commodore][commodore] Component for rbac.
...
The rendered documentation for this component is available on the [Commodore Components Hub](https://hub.syn.tools/rbac).
